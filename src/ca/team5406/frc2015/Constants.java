...
public class Constants {
	...
	public static Constant canHolderContraction = new Constant("canHolderContraction", 6);
	public static Constant canHolderExpansion = new Constant("canHolderExpansion", 7);
